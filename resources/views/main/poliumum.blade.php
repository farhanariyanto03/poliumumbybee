            ...
            <div class="card-body wizard-content">
                ...
                <form action="#" class="validation-wizard wizard-circle mt-5">
                    ...
                    <section>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <script>
                                    // Isi select saat halaman dimuat
                                    $(document).ready(function () {
                                        $.ajax({
                                            url: '/list-no-rm', // ganti dengan endpoint kamu
                                            method: 'GET',
                                            dataType: 'json',
                                            ...
                                            error: function () {
                                                alert('Gagal mengambil daftar No. RM');
                                            }
                                        });
                                    });
                                </script>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="texr" class="form-control required" id="notelpwali"
                                                name="notelpwali" placeholder="08xxxxxxxxxx" pattern="[0-9]{10,13}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <section>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <select class="form-select" id="searchNoRM">
                                    <!-- <option value="">-- Pilih No. RM --</option>
          <option value="RM001">RM001 - Budi</option>
          <option value="RM002">RM002 - Siti</option>
          <option value="RM003">RM003 - Agus</option> -->
                                    <!-- Bisa diisi dinamis juga via JavaScript -->
                                </select>
                            ...
                            <div class="col-md-2">
                                ...
                                <button class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#modalDataPendaftaran">
                                    Cari
                                </button>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="modalDataPendaftaran" tabindex="-1" aria-labelledby="modalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalLabel">Data Pendaftaran</h5>
                        ...
                        <script>
                            function searchRM() {
                                const noRM = $('#searchNoRM').val();

                                if (!noRM) {
                                    alert('Silakan masukkan No. RM terlebih dahulu.');
                                    return;
                                }

                                // Ambil data dulu
                                $.ajax({
                                    url: `{{ url('/pendaftaran?no_rm=${noRM}') }}`, // Ganti sesuai endpoint kamu
                                    method: 'GET',
                                    dataType: 'json',
                                    success: function (response) {
                                        const tbody = $('#dataPendaftaranBody');
                                        tbody.empty();
                            ...
                            <tr>
                              ...
                              <td>${item.dokter}</td>
                              <td>${item.tipe_pasien}</td>
                              <td><span class="text-danger">${item.status}</span></td>
                              <td><button class="btn btn-primary btn-sm" onclick="pilihPasien('${item.no_rm}', '${item.nama_pasien}')">Pilih</button></td>
                            </tr>`;
                                                tbody.append(row);
                                            });
                                        }

                                        // Tampilkan modal HANYA setelah data selesai dimuat
                                        const modal = new bootstrap.Modal(document.getElementById('modalDataPendaftaran'));
                                        modal.show();
                                    },
                                    error: function () {
                            ...
                            <div class="col-md-12">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-2">
                                            <button class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#modalPemeriksaan" onclick="searchRM()">Cari</button>
                                        </div>
                                    </div>
                                    <!-- Modal -->
                                    <div class="modal fade" id="modalPemeriksaan" tabindex="-1" aria-labelledby="modalLabel"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                <div class="modal-header">
