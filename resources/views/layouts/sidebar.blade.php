...
<nav class="sidebar-nav scroll-sidebar" data-simplebar>
    ...
    <ul class="first-level {{ request()->is('persuratan*') ? 'in' : '' }} collapse" aria-expanded="false">
        
        <li class="sidebar-item">
            <a class="sidebar-link {{ request()->is('persuratan/surat-kematian*') ? 'active' : '' }}" 
                href="{{ route('surat.kematian') }}" aria-expanded="false">
                <div class="round-16 d-flex align-items-center justify-content-center">
                    <i class="ti ti-circle"></i>
                </div>
        ...
        <li class="sidebar-item">
            <a class="sidebar-link {{ request()->is('persuratan/surat-keterangan-sehat*') ? 'active' : '' }}" 
        ...
        <li class="sidebar-item">
            <a class="sidebar-link {{ request()->is('persuratan/surat-keterangan-sakit*') ? 'active' : '' }}" 
        ...
        <li class="sidebar-item">
            <a class="sidebar-link {{ request()->is('persuratan/surat-control*') ? 'active' : '' }}" 
                href="{{ route('surat.control') }}" aria-expanded="false">
                <div class="round-16 d-flex align-items-center justify-content-center">
                    <i class="ti ti-circle"></i>
                </div>
