...
<nav class="sidebar-nav scroll-sidebar" data-simplebar>
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
            <a class="sidebar-link has-arrow {{ request()->is('/') || request()->is('main/blog-detail') || request()->is('surat-keterangan-sakit*') ? 'active' : '' }}"
                href="#" aria-expanded="false">
                <span class="hide-menu">Persuratan</span>
            </a>
            <ul class="first-level collapse {{ request()->is('/') || request()->is('main/blog-detail') || request()->is('surat-keterangan-sakit*') ? 'in' : '' }}"
                aria-expanded="false">
