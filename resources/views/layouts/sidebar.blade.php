    ...
    <div>
        ...
        <div class="brand-logo d-flex align-items-center justify-content-between py-3 px-4">
            <a href="{{ route('dashboard') }}" class="logo-img text-decoration-none d-flex align-items-center">
                <img src="{{ URL::asset('build/images/logos/logopengembang.png') }}" alt="Logo"
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            <ul id="sidebarnav" class="list-unstyled">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->is('pendaftaran*') ? 'active' : '' }}"
                        ...
                        <span class="d-flex align-items-center"><i class="bi bi-person-add me-2"></i></span>
                        <span>Pendaftaran</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/riwayat" aria-expanded="false">
                        <span class="d-flex align-items-center"><i class="bi bi-journal-medical me-2"></i></span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow {{ request()->is('farmasi*') || request()->is('pembayaran*') ? 'active' : '' }}"
                        ...
                        <span class="d-flex align-items-center"><i class="bi bi-capsule-pill me-2"></i></span>
                        <span>Farmasi & Pembayaran</span>
                    </a>
                    <ul class="first-level collapse {{ request()->is('farmasi*') || request()->is('pembayaran*') ? 'show' : '' }}"
                        aria-expanded="false">
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="/farmasi/resep"><span class="hide-menu">Resep Obat</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="/pembayaran"><span class="hide-menu">Bayar</span></a>
                        </li>
                    </ul>
                </li>
                <!-- Pembayaran -->
            ...
            <!-- Poli Umum -->
            <li class="sidebar-item">
                <a class="sidebar-link has-arrow {{ request()->is('poliumum*') ? 'active' : '' }}" href="#"
                    aria-expanded="false">
                    <span class="d-flex align-items-center">
            ...
            <!-- Poli KIA -->
            <li class="sidebar-item">
                <a class="sidebar-link {{ request()->is('polikia*') ? 'active' : '' }}" href="/main/polikia"
                    aria-expanded="false">
                    <span class="d-flex align-items-center">
            ...
            <!-- Rawat Inap -->
            <li class="sidebar-item">
                <a class="sidebar-link {{ request()->is('rawatinap*') ? 'active' : '' }}" href="/main/rawatinap"
                    aria-expanded="false">
                    <span class="d-flex align-items-center">
            ...
            <!-- Persuratan -->
            <li class="sidebar-item">
                <a class="sidebar-link has-arrow {{ request()->is('surat*', 'surat-keterangan-sehat*','surat-keterangan-sakit*') ? 'active' : '' }}"
                    href="#" aria-expanded="false">
                    <span class="d-flex align-items-center">
                ...
                <ul class="first-level collapse {{ request()->is('surat*', 'surat-keterangan-sehat*', 'surat-keterangan-sakit*') ? 'show' : '' }}"
                    aria-expanded="false">
                    <li class="sidebar-item">
            ...
            <!-- Rekam Medis -->
            <li class="sidebar-item">
                <a class="sidebar-link has-arrow {{ request()->is('rekammedis*') ? 'active' : '' }}" href="#"
                    aria-expanded="false">
                    <span class="d-flex align-items-center">
            ...
            <li class="sidebar-item">
                ...
                <ul class="first-level collapse {{ request()->is('masterdata*') ? 'show' : '' }}" aria-expanded="false">
                    <li class="sidebar-item">
                        <a class="sidebar-link {{ request()->is('masterdata/dokter') ? 'active' : '' }}"
